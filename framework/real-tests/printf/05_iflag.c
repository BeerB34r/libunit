...
int	printf_iflag_test(void)
{
	...
	if (!retval)
		retval = printing_test("1", "", &check_return_three);
	if (!retval)
		retval = printing_test("2147483647i21474836470i2147483647", "", &check_return_four);
	if (!retval)
		retval = printing_test("-10-2147483648i0", "", &check_return_five);
	if (retval)
		return (retval);
	return (0);
}